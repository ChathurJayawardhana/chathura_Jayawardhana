  ...
  return (
    <div name="service" className='w-full bg-white py-16 px-8'>
       ...
       <div className='grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 gap-6 py-4 px-4 pl-12'>
        {
            service.map((item)=>(
                <div className='border-none hover:scale-105 duration-300 bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-4 px-4 '>
                <img src={item.src} className='w-[100px] h-[100px] mx-8 my-4'/> 
                <div>
                    <h3>{item.Title}</h3>
