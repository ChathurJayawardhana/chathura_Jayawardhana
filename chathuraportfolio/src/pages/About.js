...
export default function About() {
  return (
    <div name="about" className='w-full bg-white py-16 px-8'>
      <h3 className='text-orange-500 font-bold text-2xl text-center'> About Me</h3>
      <div className='w-[1520] mx-auto pt-6 flex flex-col items-center'>
        ...
        <div className='flex flex-col justify-center pt-8 md:text-3xl sm:text-2xl lg:text-3xl text-black'>
